<?php
	//iniciamos sesion para que cada usuario tenga un archivo diferente
	session_start();
	
	$compra_path = $_SERVER['DOCUMENT_ROOT'] . '/M4/xslt/compraV/compra-';
	...
	//escribimos en el archivo con returns y tabuladores
	fwrite($gestor, "<?xml version='1.0' encoding='UTF-8'?>");
    fwrite($gestor, PHP_EOL);
	fwrite($gestor, "<?xml-stylesheet href='carritoV.xsl'	type='text/xsl'?>");
    fwrite($gestor, PHP_EOL);
	...
	if ($article) {
		...
		//el articulo no existe, agregar uno nuevo
